...
import MyPic from '../../assets/img/profile/MyPic.jpg'
    ...
    return (
        ...
        <Container >
            ...
            <Row className="justify-content-center mb-2 mr-2 ">
                <Image className="profile justify-content-end" alt="profile" src={MyPic} roundedCircle thumbnail fluid/>
                </Row>
                </Col>

                <Col xs={12} md={6}>
                    <Row className=" align-items-start p-2 my-details rounded">
                    Hi there! My name is <strong>&nbsp;Chirag</strong>
